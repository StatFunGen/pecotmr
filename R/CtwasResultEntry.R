...
#' @export
CtwasResultEntry <- function(finemap = NULL, susieAlpha = NULL, param = NULL,
                             regionInfo = NULL) {
  new("CtwasResultEntry", finemap = finemap, susieAlpha = susieAlpha,
      param = param, regionInfo = regionInfo)
}
