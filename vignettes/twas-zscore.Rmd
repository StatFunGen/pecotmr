...
`causalInferencePipeline()` pairs QTL fine-mapping and/or regularized regression weights one or more GWAS studies to produce, per
`(qtlStudy, context, trait, method, gwasStudy)` tuple:

- a **TWAS Z-score** (and p-value), and
- when `fineMappingResult` is supplied, a **Mendelian
  Randomization Wald-ratio** estimate over the QTL credible sets.
